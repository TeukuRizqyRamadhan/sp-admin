...
const AppHeader: React.FC = () => {
  ...
  useEffect(() => {
    const fetchAdmin = async () => {
      ...
      try {
        const response = await fetch("http://192.168.1.224:3000/admin/me", {
          headers: {
      ...
      <div className="flex flex-col items-center justify-between flex-grow lg:flex-row lg:px-6">
        ...
        >
          <div className="flex items-center gap-2 2xsm:gap-3">
            ...
            <ThemeToggleButton />
            {/* <!-- Dark Mode Toggler --> */}
            <p className="text-gray-600 dark:text-gray-400 dark:text-white">{adminName ? `Halo, ${adminName}` : "Halo, Admin"}</p>
          </div>
          {/* <!-- User Area --> */}
          <button
